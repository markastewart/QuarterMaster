...
struct RothConversionWhatIf {
    ...
    static func compare(
        ...
        whatIfFedEstimate.totalTax = FederalTaxCalculator.annualTaxCalc(taxPeriodInput: whatIfInput, fedEstimate: whatIfFedEstimate) - SeasonalConstants.foreignTaxPaid
